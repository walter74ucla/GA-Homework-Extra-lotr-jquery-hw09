...
const forgeTheFellowShip = () => {
  ...
  const $div = $('<div/>');
  $div.attr('id', 'the-fellowship').append(`<h1>The Fellowship</li>`);
  // 2. add an h1 with the text 'The Fellowship' to this new div

  // 3. append the fellowship to middle-earth
  $('#middle-earth').append($div);
  // 4. add the unordered lists of hobbits and buddies to 'the-fellowship'
  $('#the-fellowship').append($('#Rivendell>ul'), $('aside>ul'));
...
const theBalrog = () => {
  ...
  $('.buddy').eq(0).text('Gandalf the White').attr('class', 'buddy the-white');
...
const itsDangerousToGoAlone = () => {
  ...
  $('#Mordor').append(($('.hobbit').eq(0)), ($('.hobbit').eq(1)));
...
const thereAndBackAgain = () => {
  ...
  $('#The-Shire').append(($('.hobbit').eq(0)), ($('.hobbit').eq(1)),($('.hobbit').eq(2)), ($('.hobbit').eq(3)));
};
